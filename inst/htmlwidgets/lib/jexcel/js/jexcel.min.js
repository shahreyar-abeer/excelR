...
;(function (global, factory) {
    ...
    var jexcel = (function(el, options) {
        ...
        obj.createTable = function() {
            ...
            if (obj.options.hideIndex) {
              console.log("hide index inside");
              obj.hideIndex();
            }
        ...
        */
        ...
        obj.getFreezeWidth = function() {
            ...
            if (obj.options.freezeColumns > 0) {
                for (var i = 0; i < obj.options.freezeColumns-1; i++) {
        ...
        obj.updateFreezePosition = function() {
            ...
            if (scrollLeft > 50) {
                for (var i = 0; i < obj.options.freezeColumns; i++) {
                    ...
                    if (i === 0) {
                      obj.thead.rows[0].getElementsByClassName("jexcel_selectall")[0].style.left = '0px';
                      obj.thead.rows[0].getElementsByClassName("jexcel_selectall")[0].style.zIndex = 3;
                    }
                    for (var j = 0; j < obj.rows.length; j++) {
                        if (obj.rows[j] && obj.records[j][i]) {
                            ...
                            obj.rows[j].getElementsByClassName("jexcel_row")[0].classList.add("jexcel_freezed");
                            obj.rows[j].getElementsByClassName("jexcel_row")[0].style.left = scrollLeft + 'px';
                        }
                    }
                }
            } else {
                for (var i = 0; i < obj.options.freezeColumns; i++) {
                    ...
                    for (var j = 0; j < obj.rows.length; j++) {
                        if (obj.records[j][i]) {
                            ...
                            obj.rows[j].getElementsByClassName("jexcel_row")[0].classList.remove("jexcel_freezed");
                            obj.rows[j].getElementsByClassName("jexcel_row")[0].style.left = '';
                        }
                    }
                }
            }
